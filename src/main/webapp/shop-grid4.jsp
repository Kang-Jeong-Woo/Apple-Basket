			...
			<div class="row">
							...
							<div class="latest-product__text">
								...
								<div class="latest-product__slider owl-carousel">
									...
									<div class="latest-prdouct__slider__item">
										<a
											href="shop-details.jsp?itemSeq=<%=list.get(i).getItemSeq()%>"
											class="latest-product__item"> <span
											class="latest-product__item__pic"> <img
												alt="freshmeat" src="./img/<%= list.get(i).getItemImg1()%>">
										</span> <span class="latest-product__item__text"> <span><%=list.get(i).getItemName() %></span>
				...
				<div class="col-lg-9 col-md-7">
						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-4">
								<div class="filter__found">
									<h6>
										<span><%=list.size() %></span> 개의 제품을 찾았습니다
									</h6>
								</div>
							</div>
						...
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="product__item">
								<div class="product__item__pic set-bg">
									<span><a
										href="shop-details.jsp?itemSeq=<%=list.get(i).getItemSeq()%>"><img
											alt="freshmeat" src="./img/<%= list.get(i).getItemImg1()%>"></a></span>
								...
								<div class="product__item__text">
									<div>
										...
										<span><a href="./shop-details.jsp"
											style="text-decoration: none !important; color: inherit !important;"><%=list.get(i).getItemName()%></a></span>
									</div>
									<div>
					...
					<div class="product__pagination">
						<a href="shop-grid.jsp">1</a> <a href="shop-grid2.jsp">2</a> <a
							href="shop-grid3.jsp">3</a> <a href="shop-grid4.jsp">4</a> <a
							href="shop-grid2.jsp"><i class="fa fa-long-arrow-right"></i></a>
					</div>
